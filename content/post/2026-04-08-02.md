...
author: 杆子
date: 2026-04-08T12:33:11+08:00
categories:
  - 网络
---
...
### 2.3 移植 weisaygrace 样式

（可选）

如果想保留 weisaygrace 的部分视觉风格，在 `assets/css/custom.css` 中引入原主题的颜色变量和字体设置：
...
在 WordPress 安装 [wordpress-to-hugo-exporter](https://github.com/SchumacherFM/wordpress-to-hugo-exporter) 插件，一键导出所有文章为 Hugo 格式的 Markdown 文件（含 front matter）。
...
Hugo 静态站点可使用 [Pagefind](https://pagefind.app/) 实现本地搜索：
...
- [Cloudflare Pages Hugo 部署指南](https://developers.cloudflare.com/pages/framework-guides/deploy-a-hugo-site/)
- [Stack 主题文档](https://stack.jimmycai.com/)
- [Giscus 评论配置](https://giscus.app/zh-CN)
