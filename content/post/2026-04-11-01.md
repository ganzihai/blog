...
author: 杆子
date: 2026-04-11T09:27:32+08:00
categories:
  - 教程
---
![cover_image](https://wsrv.nl/?output=webp&url=https://mmbiz.qpic.cn/sz_mmbiz_jpg/R4dg0ib2nglI7I3eEYqEbPSScYvyL7z1mmI9zUCI5icZTibrypPBD24VSlIJBejVn8C3w2upbJErmQOVz1P1u5Us4YzhZUvvtNQzY2hm0oJbWA/0?wx_fmt=jpeg)

> 19k Star，又一个 WireGuard 零信任项目火了！Pangolin 凭什么让开发者抛弃 Tailscale？

![pangolin_cover](https://wsrv.nl/?output=webp&url=https://mmbiz.qpic.cn/mmbiz_png/R4dg0ib2nglJ0qVR1X2rObQicOiaG1EoRlgViaiasIU5W4lEQhG66Rqg3Jq1CJFKOjyiaIsvnEqYicpnTVebmo0T4OChO4xVLdHoTiatiavf3n4L7a5g/640?from=appmsg)
...
### 架构原理：Hub-Spoke，不是 Mesh

Tailscale 用的是 Mesh 网状拓扑，每个设备都能直连其他设备。设备多了，管理 ACL 的复杂度是 N² 增长的。

Pangolin 选了 Hub-Spoke 模式：

![pangolin_01](https://wsrv.nl/?output=webp&url=https://mmbiz.qpic.cn/mmbiz_png/R4dg0ib2nglIIHjYh0HpbqgECL3ibOPlutIhQnraG8Zun4J10iaLlPhe5DkSqD8uib27iazJb6xMh01tECHF5SibPTQlQH1u1z2vU2d2Bd8nia9ibv8/640?from=appmsg)
...
数据流是这样的：`Client → Site → 目标资源`。Server 只帮忙协调，不碰数据。
...
每个资源可以有 DNS 别名。比如你内网有一台 MySQL 跑在 `192.168.1.210`，Pangolin 里给它起个别名 `db-prod.my-org.internal`，连上就能用。
...
![pangolin_02](https://wsrv.nl/?output=webp&url=https://mmbiz.qpic.cn/sz_mmbiz_png/R4dg0ib2nglKzibsyC20Q5Ec5Tic0Ds0SEjoNIZibsdaNzsNCsaJbuR3dzxy6czKC6jtAsPweEJQWXhvKlDOH1s8N8uqBF1Hk0mlnUmCBvYia4d0/640?from=appmsg)
...
启动后访问 `https://你的域名`，跟着 Web 引导完成初始化就行。详细步骤看官方文档。
